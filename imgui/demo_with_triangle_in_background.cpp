...
int main(int, char**)
{
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    //   ImGui::SetNextWindowSize(ImVec2(W + 10, H + 10), ImGuiCond_FirstUseEver);
    ...
    //   //                                      ImVec2(ImGui::GetItemRectMin().x + pos.x, ImGui::GetItemRectMin().y +
    //   //                                      pos.y), ImVec2(pos.x + h / 2, pos.y + w / 2), ImVec2(0, 1), ImVec2(1, 0));
