...
// (GLFW is a cross-platform general purpose library for handling windows, inputs, OpenGL/Vulkan graphics context
// creation, etc.)

#include "texture_renderer.hpp"
#include "four_color_texure.hpp"
#include "rectengle_renderer.hpp"
...
int main(int, char**)
{
  ...
  // four_color_texure the_texture(0xff00ffff,0xff0000ff,0x000000ff,0x00ff00ff);
  four_color_texure the_texture;
  rectengle_renderer the_rectengle_renderer;
  texture_renderer the_texture_renderer(the_texture.texture());
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    }
    {
      ...
      ImGui::Image(reinterpret_cast<void*>(the_texture.texture()),{640,480});
      ImGui::End();
    }
    ...
    the_texture_renderer.render();
    // the_rectengle_renderer.render();
    // the_triangle_render.render();
